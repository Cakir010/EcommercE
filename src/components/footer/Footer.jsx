  ...
  return (
    <div>
        ...
        <footer className="bg-white dark:bg-gray-900 ">
          <div className="mx-auto w-full max-w-screen-xl">
            <div className="grid grid-cols-1 gap-8 px-4 py-6 lg:py-8 md:grid-cols-5">
              ...
              <div>
                <h2 className="mb-6 text-sm font-bold text-gray-900 uppercase dark:text-white">UYGULAMALAR</h2>
                <ul className="text-gray-500 dark:text-gray-400 font-medium ">
                  <li className="flex">
                    <AiFillAndroid  className="m-2 text-lg"/>
                    <a href="#" className="hover:underline mt-1 ">Android Uygulama</a>
                  </li>
                  <li className="flex">
                    <AiFillApple  className="m-2 text-lg"/>
                    <a href="#" className="hover:underline mt-1">App Store Uygulama</a>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div className= "flex justify-evenly bg-gray-300 border-gray-600 m-12"  >
        ...
        <p> © 2023 <span className="font-bold">mymassa.com</span> - Tüm Hakları Saklıdır.</p>
      </div>
    </div>
  );
};
